...
import warp as wp
import math
from dexsafedagger_lab.assets.tg2_inspirehand.tg2_inspirehand import TG2_INSPIREHAND_CFG
...
@configclass
class DexSafeDaggerTG2InspirehandEnvCfg(DirectRLEnvCfg):
    ...
    # robot
    robot_cfg: ArticulationCfg = TG2_INSPIREHAND_CFG.replace(prim_path="/World/envs/env_.*/Robot").replace(
    ...
    shoulder_pitch_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/shoulder_pitch_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
    ...
    shoulder_roll_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/shoulder_roll_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
    ...
    shoulder_yaw_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/shoulder_yaw_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
    ...
    elbow_pitch_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/elbow_pitch_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
    ...
    elbow_yaw_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/elbow_yaw_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
    ...
    wrist_pitch_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/wrist_pitch_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
    ...
    wrist_roll_r_link_table_contact_sensor: ContactSensorCfg = ContactSensorCfg(
        prim_path="/World/envs/env_.*/Robot/wrist_roll_r_link",
        update_period=0.0,
        history_length=6,
        debug_vis=False,
        # Focus on contacts with the cube and table (add other objects as needed)
