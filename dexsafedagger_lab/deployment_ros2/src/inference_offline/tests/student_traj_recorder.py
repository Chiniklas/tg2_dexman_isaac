...
def _find_repo_root(start: pathlib.Path) -> pathlib.Path:
    needle = pathlib.Path("dexsafedagger_lab/tasks/tg2_inspirehand/agents/rl_games_ppo_stereo_transformer.yaml")
...
def main(env_cfg, _agent_cfg: dict) -> None:
    ...
    if args_cli.student_cfg is None:
        ...
        student_cfg = root / "dexsafedagger_lab/tasks/tg2_inspirehand/agents/rl_games_ppo_stereo_transformer.yaml"
    else:
