...
```bash
source /opt/ros/humble/setup.bash
cd /home/chi/tg2_dexman_isaac/dexsafedagger_lab/deployment_ros2
...
For the full camera calibration workflow and test utilities, see [src/calibration/README.md](/home/chi/tg2_dexman_isaac/dexsafedagger_lab/deployment_ros2/src/calibration/README.md).
