...
parser.add_argument("--task", type=str, default="dexsafedagger_tg2_inspirehand", help="Task name.")
parser.add_argument(
    "--objects_dir",
    type=str,
    default="test_object",
...
import dexsafedagger_lab.tasks.dexsafedagger_kuka_allegro.gym_setup  # noqa: F401
import dexsafedagger_lab.tasks.dexsafedagger_kuka_inspirehand.gym_setup  # noqa: F401
