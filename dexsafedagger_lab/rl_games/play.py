"""Play a TG2 InspireHand teacher checkpoint with RL-Games."""
...
# CLI
parser = argparse.ArgumentParser(description="Play a TG2 InspireHand teacher checkpoint with RL-Games.")
