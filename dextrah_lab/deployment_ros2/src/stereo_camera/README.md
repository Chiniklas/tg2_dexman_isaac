ROS 2 stereo camera package for the TG2 Inspirehand dual OV9732 setup.

## ROS 2 usage

- Run the stereo publisher directly:
  ```bash
...
The rest of this document covers the lower-level camera utilities and calibration helpers that are also shipped with the package source.
